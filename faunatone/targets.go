...
var (
	instrumentTargets = [][]*tabTarget{
		...
		// GS
		{
			...
			{display: "E. Piano 1w", value: "5 16 0"},
			{display: "60's E. Piano", value: "5 24 0"},
			{display: "E. Piano 2", value: "6 0 0"},
			{display: "Detuned EP 2", value: "6 8 0"},
			{display: "E. Piano 2w", value: "6 16 0"},
			{display: "Harpsichord", value: "7 0 0"},
			{display: "Coupled Harpsichord", value: "7 8 0"},
			{display: "Harpsichord w", value: "7 16 0"},
			{display: "Harpsichord o", value: "7 24 0"},
			{display: "Clavinet", value: "8 0 0"},
			{display: "Celesta", value: "9 0 0"},
			{display: "Glockenspiel", value: "10 0 0"},
			{display: "Music Box", value: "11 0 0"},
			{display: "Vibraphone", value: "12 0 0"},
			{display: "Vibraphone w", value: "12 8 0"},
			{display: "Marimba", value: "13 0 0"},
			...
			{display: "Detuned Organ 2", value: "18 8 0"},
			{display: "Organ 5", value: "18 32 0"},
			{display: "Organ 3", value: "19 0 0"},
			{display: "Church Org.1", value: "20 0 0"},
			{display: "Church Org.2", value: "20 8 0"},
			{display: "Church Org.3", value: "20 16 0"},
			{display: "Reed Organ", value: "21 0 0"},
			{display: "Accordion French", value: "22 0 0"},
			{display: "Accordion Italian", value: "22 8 0"},
			{display: "Harmonica", value: "23 0 0"},
			{display: "Bandoneon", value: "24 0 0"},
			{display: "Nylon String Guitar", value: "25 0 0"},
			{display: "Ukulele", value: "25 8 0"},
			{display: "Nylon Guitar o", value: "25 16 0"},
			{display: "Nylon Guitar 2", value: "25 32 0"},
			{display: "Steel String Guitar", value: "26 0 0"},
			{display: "12 String Guitar", value: "26 8 0"},
			{display: "Mandolin", value: "26 16 0"},
			{display: "Jazz Guitar", value: "27 0 0"},
			{display: "Hawaiian Guitar", value: "27 8 0"},
			{display: "Clean Guitar", value: "28 0 0"},
			{display: "Chorus Guitar", value: "28 8 0"},
			{display: "Muted Gt.", value: "29 0 0"},
			{display: "Funk Guitar", value: "29 8 0"},
			{display: "Funk Guitar 2", value: "29 16 0"},
			{display: "Overdrive Guitar", value: "30 0 0"},
			{display: "Distortion Guitar", value: "31 0 0"},
			{display: "Feedback Guitar", value: "31 8 0"},
			{display: "Guitar Harmonics", value: "32 0 0"},
			{display: "Guitar Feedback", value: "32 8 0"},
			{display: "Acoustic Bass", value: "33 0 0"},
			{display: "Fingered Bass", value: "34 0 0"},
			{display: "Picked Bass", value: "35 0 0"},
			{display: "Fretless Bass", value: "36 0 0"},
			{display: "Slap Bass 1", value: "37 0 0"},
			{display: "Slap Bass 2", value: "38 0 0"},
			{display: "Synth Bass 1", value: "39 0 0"},
			{display: "Synth Bass 101", value: "39 1 0"},
			...
			{display: "Slow Strings", value: "50 0 0"},
			{display: "Synth Strings1", value: "51 0 0"},
			{display: "Synth Strings 3", value: "51 8 0"},
			{display: "Synth Strings2", value: "52 0 0"},
			{display: "Choir Aahs", value: "53 0 0"},
			{display: "Choir Aahs 2", value: "53 32 0"},
			{display: "Voice Oohs", value: "54 0 0"},
			{display: "Synth Vox", value: "55 0 0"},
			{display: "Orchestra Hit", value: "56 0 0"},
			{display: "Trumpet", value: "57 0 0"},
			{display: "Trombone", value: "58 0 0"},
			...
			{display: "Muted Trumpet", value: "60 0 0"},
			{display: "French Horn", value: "61 0 0"},
			{display: "French Horn2", value: "61 1 0"},
			{display: "Brass 1", value: "62 0 0"},
			{display: "Brass 2", value: "62 8 0"},
			{display: "Synth Brass 1", value: "63 0 0"},
			{display: "Synth Brass 3", value: "63 8 0"},
			{display: "Analog Brass 1", value: "63 16 0"},
			{display: "Synth Brass 2", value: "64 0 0"},
			{display: "Synth Brass 4", value: "64 8 0"},
			{display: "Analog Brass 2", value: "64 16 0"},
			{display: "Soprano Sax", value: "65 0 0"},
			{display: "Alto Sax", value: "66 0 0"},
			{display: "Tenor Sax", value: "67 0 0"},
			{display: "Baritone Sax", value: "68 0 0"},
			...
			{display: "Recorder", value: "75 0 0"},
			{display: "Pan Flute", value: "76 0 0"},
			{display: "Bottle Blow", value: "77 0 0"},
			{display: "Shakuhachi", value: "78 0 0"},
			{display: "Whistle", value: "79 0 0"},
			{display: "Ocarina", value: "80 0 0"},
			...
			{display: "Synth Calliope", value: "83 0 0"},
			{display: "Chiffer Lead", value: "84 0 0"},
			{display: "Charang", value: "85 0 0"},
			{display: "Solo Vox", value: "86 0 0"},
			{display: "5th Saw Wave", value: "87 0 0"},
			{display: "Bass & Lead", value: "88 0 0"},
			{display: "Fantasia", value: "89 0 0"},
			{display: "Warm Pad", value: "90 0 0"},
			{display: "Polysynth", value: "91 0 0"},
			{display: "Space Voice", value: "92 0 0"},
			{display: "Bowed Glass", value: "93 0 0"},
			{display: "Metal Pad", value: "94 0 0"},
			{display: "Halo Pad", value: "95 0 0"},
			{display: "Sweep Pad", value: "96 0 0"},
			{display: "Ice Rain", value: "97 0 0"},
			{display: "Soundtrack", value: "98 0 0"},
			{display: "Crystal", value: "99 0 0"},
			{display: "Synth Mallet", value: "99 1 0"},
			{display: "Atmosphere", value: "100 0 0"},
			{display: "Brightness", value: "101 0 0"},
			{display: "Goblin", value: "102 0 0"},
			{display: "Echo Drops", value: "103 0 0"},
			{display: "Echo Bell", value: "103 1 0"},
			{display: "Echo Pan", value: "103 2 0"},
			{display: "Star Theme", value: "104 0 0"},
			{display: "Sitar", value: "105 0 0"},
			...
			{display: "Kalimba", value: "109 0 0"},
			{display: "Bag Pipe", value: "110 0 0"},
			{display: "Fiddle", value: "111 0 0"},
			{display: "Shannai", value: "112 0 0"},
			{display: "Tinkle Bell", value: "113 0 0"},
			{display: "Agogo", value: "114 0 0"},
			{display: "Steel Drums", value: "115 0 0"},
			{display: "Woodblock", value: "116 0 0"},
			...
			{display: "Melodic Tom 1", value: "118 0 0"},
			{display: "Melodic Tom 2", value: "118 8 0"},
			{display: "Synth Drum", value: "119 0 0"},
			{display: "808 Tom", value: "119 8 0"},
			{display: "Elec Perc", value: "119 9 0"},
			{display: "Reverse Cymbal", value: "120 0 0"},
			{display: "Guitar Fret Noise", value: "121 0 0"},
			{display: "Guitar Cut Noise", value: "121 1 0"},
			{display: "String Slap", value: "121 2 0"},
			{display: "Breath Noise", value: "122 0 0"},
			{display: "Flute Key Click", value: "122 1 0"},
			{display: "Seashore", value: "123 0 0"},
			...
			{display: "Door Creaking", value: "125 2 0"},
			{display: "Door Slam", value: "125 3 0"},
		...
		// MT-32
		{
			{value: "1", display: "Acoustic Piano 1"},
			{value: "2", display: "Acoustic Piano 2"},
			{value: "3", display: "Acoustic Piano 3"},
			{value: "4", display: "Electric Piano 1"},
			{value: "5", display: "Electric Piano 2"},
			{value: "6", display: "Electric Piano 3"},
			{value: "7", display: "Electric Piano 4"},
			{value: "8", display: "Honkytonk"},
			{value: "9", display: "Electric Organ 1"},
			{value: "10", display: "Electric Organ 2"},
			{value: "11", display: "Electric Organ 3"},
			{value: "12", display: "Pipe Organ 1"},
			{value: "13", display: "Pipe Organ 2"},
			{value: "14", display: "Pipe Organ 3"},
			{value: "15", display: "Pipe Organ 4"},
			{value: "16", display: "Accordion"},
			{value: "17", display: "Harpsichord 1"},
			{value: "18", display: "Harpsichord 2"},
			{value: "19", display: "Harpsichord 3"},
			{value: "20", display: "Clavi 1"},
			{value: "21", display: "Clavi 2"},
			{value: "22", display: "Clavi 3"},
			{value: "23", display: "Celesta 1"},
			{value: "24", display: "Celesta 2"},
			{value: "25", display: "Synth Brass 1"},
			{value: "26", display: "Synth Brass 2"},
			{value: "27", display: "Synth Brass 3"},
			{value: "28", display: "Synth Brass 4"},
			{value: "29", display: "Synth Bass 1"},
			{value: "30", display: "Synth Bass 2"},
			{value: "31", display: "Synth Bass 3"},
			{value: "32", display: "Synth Bass 4"},
			{value: "33", display: "Fantasy"},
			{value: "34", display: "Harmonic Pan"},
			{value: "35", display: "Chorale"},
			{value: "36", display: "Glasses"},
			{value: "37", display: "Soundtrack"},
			{value: "38", display: "Atmosphere"},
			{value: "39", display: "Warm Bells"},
			{value: "40", display: "Funny Vox"},
			{value: "41", display: "Echo Bell"},
			{value: "42", display: "Ice Rain"},
			{value: "43", display: "Oboe 2001"},
			{value: "44", display: "Echo Pan"},
			{value: "45", display: "Doctor Solo"},
			{value: "46", display: "Schooldaze"},
			{value: "47", display: "Bellsinger"},
			{value: "48", display: "Square Wave"},
			{value: "49", display: "String Section 1"},
			{value: "50", display: "String Section 2"},
			{value: "51", display: "String Section 3"},
			{value: "52", display: "Pizzicato"},
			{value: "53", display: "Violin 1"},
			{value: "54", display: "Violin 2"},
			{value: "55", display: "Cello 1"},
			{value: "56", display: "Cello 2"},
			{value: "57", display: "Contrabass"},
			{value: "58", display: "Harp 1"},
			{value: "59", display: "Harp 2"},
			{value: "60", display: "Guitar 1"},
			{value: "61", display: "Guitar 2"},
			{value: "62", display: "Electric Guitar 1"},
			{value: "63", display: "Electric Guitar 2"},
			{value: "64", display: "Sitar"},
			{value: "65", display: "Acoustic Bass 1"},
			{value: "66", display: "Acoustic Bass 2"},
			{value: "67", display: "Electric Bass 1"},
			{value: "68", display: "Electric Bass 2"},
			{value: "69", display: "Slap Bass 1"},
			{value: "70", display: "Slap Bass 2"},
			{value: "71", display: "Fretless 1"},
			{value: "72", display: "Fretless 2"},
			{value: "73", display: "Flute 1"},
			{value: "74", display: "Flute 2"},
			{value: "75", display: "Piccolo 1"},
			{value: "76", display: "Piccolo 2"},
			{value: "77", display: "Recorder"},
			{value: "78", display: "Pan Pipes"},
			{value: "79", display: "Saxophone 1"},
			{value: "80", display: "Saxophone 2"},
			{value: "81", display: "Saxophone 3"},
			{value: "82", display: "Saxophone 4"},
			{value: "83", display: "Clarinet 1"},
			{value: "84", display: "Clarinet 2"},
			{value: "85", display: "Oboe"},
			{value: "86", display: "English Horn"},
			{value: "87", display: "Bassoon"},
			{value: "88", display: "Harmonica"},
			{value: "89", display: "Trumpet 1"},
			{value: "90", display: "Trumpet 2"},
			{value: "91", display: "Trombone 1"},
			{value: "92", display: "Trombone 2"},
			{value: "93", display: "French Horn 1"},
			{value: "94", display: "French Horn 2"},
			{value: "95", display: "Tuba"},
			{value: "96", display: "Brass Section 1"},
			{value: "97", display: "Brass Section 2"},
			{value: "98", display: "Vibraphone 1"},
			{value: "99", display: "Vibraphone 2"},
			{value: "100", display: "Synth Mallet"},
			{value: "101", display: "Wind Bell"},
			{value: "102", display: "Glockenspiel"},
			{value: "103", display: "Tube Bell"},
			{value: "104", display: "Xylophone"},
			{value: "105", display: "Marimba"},
			{value: "106", display: "Koto"},
			{value: "107", display: "Sho"},
			{value: "108", display: "Shakuhachi"},
			{value: "109", display: "Whistle 1"},
			{value: "110", display: "Whistle 2"},
			{value: "111", display: "Bottleblow"},
			{value: "112", display: "Breathpipe"},
			{value: "113", display: "Timpani"},
			{value: "114", display: "Melodic Tom"},
			{value: "115", display: "Deep Snare"},
			{value: "116", display: "Electric Percussion 1"},
			{value: "117", display: "Electric Percussion 2"},
			{value: "118", display: "Taiko"},
			{value: "119", display: "Taiko Rim"},
			{value: "120", display: "Cymbal"},
			{value: "121", display: "Castanet"},
			{value: "122", display: "Triangle"},
			{value: "123", display: "Orchestra Hit"},
			{value: "124", display: "Telephone"},
			{value: "125", display: "Bird Tweet"},
			{value: "126", display: "One Note Jam"},
			{value: "127", display: "Water Bells"},
			{value: "128", display: "Jungle Tune"},
		},
	}
	...
	commomDrumTargets = []*tabTarget{
		{value: "35", display: "Acoustic Bass Drum"},
		{value: "36", display: "Bass Drum 1"},
		{value: "37", display: "Side Stick"},
		{value: "38", display: "Acoustic Snare"},
		{value: "39", display: "Hand Clap"},
		{value: "40", display: "Electric Snare"},
		{value: "41", display: "Low Floor Tom"},
		{value: "42", display: "Closed Hi Hat"},
		{value: "43", display: "High Floor Tom"},
		{value: "44", display: "Pedal Hi-Hat"},
		{value: "45", display: "Low Tom"},
		{value: "46", display: "Open Hi-Hat"},
		{value: "47", display: "Low-Mid Tom"},
		{value: "48", display: "Hi Mid Tom"},
		{value: "49", display: "Crash Cymbal 1"},
		{value: "50", display: "High Tom"},
		{value: "51", display: "Ride Cymbal 1"},
		{value: "52", display: "Chinese Cymbal"},
		{value: "53", display: "Ride Bell"},
		{value: "54", display: "Tambourine"},
		{value: "55", display: "Splash Cymbal"},
		{value: "56", display: "Cowbell"},
		{value: "57", display: "Crash Cymbal 2"},
		{value: "58", display: "Vibraslap"},
		{value: "59", display: "Ride Cymbal 2"},
		{value: "60", display: "Hi Bongo"},
		{value: "61", display: "Low Bongo"},
		{value: "62", display: "Mute Hi Conga"},
		{value: "63", display: "Open Hi Conga"},
		{value: "64", display: "Low Conga"},
		{value: "65", display: "High Timbale"},
		{value: "66", display: "Low Timbale"},
		{value: "67", display: "High Agogo"},
		{value: "68", display: "Low Agogo"},
		{value: "69", display: "Cabasa"},
		{value: "70", display: "Maracas"},
		{value: "71", display: "Short Whistle"},
		{value: "72", display: "Long Whistle"},
		{value: "73", display: "Short Guiro"},
		{value: "74", display: "Long Guiro"},
		{value: "75", display: "Claves"},
		{value: "76", display: "Hi Wood Block"},
		{value: "77", display: "Low Wood Block"},
		{value: "78", display: "Mute Cuica"},
		{value: "79", display: "Open Cuica"},
		{value: "80", display: "Mute Triangle"},
		{value: "81", display: "Open Triangle"},
	}

	drumTargets = [][]*tabTarget{
		// GM
		commomDrumTargets,

		// GS
		append(commomDrumTargets, []*tabTarget{
			{value: "27", display: "High Q"},
			{value: "28", display: "Slap Noise"},
			{value: "29", display: "Scratch Push"},
			{value: "30", display: "Scratch Pull"},
			{value: "31", display: "Drum Sticks"},
			{value: "32", display: "Square Click"},
			{value: "33", display: "Metronome Click"},
			{value: "34", display: "Metronome Bell"},
			{value: "82", display: "Shaker"},
			{value: "83", display: "Jingle Bell"},
			{value: "84", display: "Belltree"},
			{value: "85", display: "Castanets"},
			{value: "86", display: "Mute Surdo"},
			{value: "87", display: "Open Surdo"},
		}...),

		// XG
		append(commomDrumTargets, []*tabTarget{
			{value: "13", display: "Surdo Mute"},
			{value: "14", display: "Surdo Open"},
			{value: "15", display: "High Q"},
			{value: "16", display: "Whip Slap"},
			{value: "17", display: "Scratch Push"},
			{value: "18", display: "Scratch Pull"},
			{value: "19", display: "Finger Snap"},
			{value: "20", display: "Click Noise"},
			{value: "21", display: "Metronome Click"},
			{value: "22", display: "Metronome Bell"},
			{value: "23", display: "Seq Click L"},
			{value: "24", display: "Seq Click H"},
			{value: "25", display: "Brush Tap"},
			{value: "26", display: "Brush Swirl L"},
			{value: "27", display: "Brush Slap"},
			{value: "28", display: "Brush Swirl H"},
			{value: "29", display: "Snare Roll"},
			{value: "30", display: "Castanet"},
			{value: "31", display: "Snare L"},
			{value: "32", display: "Sticks"},
			{value: "33", display: "Bass Drum L"},
			{value: "34", display: "Snare Roll"},
			{value: "82", display: "Shaker"},
			{value: "83", display: "Jingle Bell"},
